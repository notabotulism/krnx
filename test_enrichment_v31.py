...
Run from anywhere:
    python3 /mnt/d/chillbot/chillbot/test_enrichment_v31.py
"""
...
# Fix path: add parent of chillbot so 'chillbot' is importable
_this_file = os.path.abspath(__file__)
_chillbot_dir = os.path.dirname(_this_file)  # /mnt/d/chillbot/chillbot
_parent_dir = os.path.dirname(_chillbot_dir)  # /mnt/d/chillbot
...
try:
    import chillbot
    print(f"[OK] chillbot module found at: {os.path.dirname(chillbot.__file__)}")
except ImportError as e:
    print(f"[ERROR] Cannot import chillbot: {e}")
...
def test_lexicon_loading():
    ...
    from chillbot.fabric.enrichment.signals import (
...
def test_pair_features():
    ...
    from chillbot.fabric.enrichment.features import FeatureExtractor, PairFeatures
...
def test_salience_breakdown():
    ...
    from chillbot.fabric.enrichment.salience import SalienceEngine, compute_salience_breakdown
...
def test_schema_output():
    ...
    from chillbot.fabric.enrichment.schema import MetadataBuilder, EnrichedMetadataV2
...
def test_full_pipeline():
    ...
    from chillbot.fabric.enrichment.relations import RelationScorer
